...
create view q1 AS
select O.OrderNo, OD.Quantity * (select I.Price from Items I where OD.ItemNo = I.ItemNo) AS totalPrice
from [Order] O, OrderDetails OD
where O.OrderNo = OD.OrderNo


create view q2 AS
select I.ItemNo,I.Name,OD.Quantity as Sold_Amount
from OrderDetails as OD
join Items as I
on I.ItemNo=OD.ItemNo
where I.ItemNo=OD.ItemNo and OD.Quantity>20;

create view q3 As
select  c.CustomerNo,c.Name
from Items as i,OrderDetails as od,Customers as c,Order1 as o
where i.ItemNo=od.ItemNo and od.Quantity*i.Price>2000 and od.OrderNo=o.OrderNo and c.CustomerNo=o.CustomerNo